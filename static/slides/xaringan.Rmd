...
---
🔆 Bir fabrikada kullanılan 3 farklı makine ile eşit miktarda ürün üretilmektedir. 1. makine ile üretilen ürünlerin 0.02'si bozuk, 2. makine ile üretilenlerin 0.05'i bozuk ve 3. makiene ile üretilenlerin 0.07'si bozuktur. Üretilen ürünlerden rastgele seçilen bir ürünün bozuk olma olasılığı nedir?
...
$P(A)=(1/7)(2/4)+(9/14)(1/4)+(1/7)(1/4)=15/56$
...
$\Large P(A_{i}|B)=\frac{P(A_{i}\cap B)}{P(B)}=\frac{P(A_{i})P(B|A_{i})}{\sum_{i=1}^{n}P(A_{i})P(B\cap A_{i})}$, $i=1,...,n$
